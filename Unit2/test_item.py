...
class TestItem(unittest.TestCase):
    ...
    def test00_init(self):
        ...
        self.assertRaises(TypeError, Item, 'guitar', 'guitar','Gibson Les Paul Standard', np.float64(500.00) ,'10001a',np.int64(5),'abc')
        self.assertRaises(TypeError, Item, 'guitar', 'guitar','Gibson Les Paul Standard', '500' ,'10001a','5','abc')
        self.assertRaises(TypeError, Item, 'bass','Ibanez Acoustic Electric',np.float64(300.10) ,'10100a', np.int64(2),55)
        self.assertRaises(ValueError, Item, 'bass','Ibanez Acoustic Electric',np.float64(-200) ,'10100a', np.int64(2),'abc')
        self.assertRaises(ValueError, Item, 'bass','Ibanez Acoustic Electric',np.float64(200) ,'10100a', np.int64(-2),'abc')
    ...
    def test03_set_price(self):
        ...
        self.assertRaises(ValueError, self.item1.set_price, np.float64(-200))
